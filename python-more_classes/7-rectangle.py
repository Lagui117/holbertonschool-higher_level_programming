...
Defines a Rectangle with width/height validation, an instance counter,
and a customizable print symbol for the string representation.
"""


class Rectangle:
    """Rectangle with private width/height, instance counter, and print symbol.
    """
