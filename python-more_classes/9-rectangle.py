#!/usr/bin/python3
"""Module 9-rectangle: Rectangle with classmethod square()."""


class Rectangle:
    """Defines a rectangle with private width/height, instance counter,
    customizable print symbol, area comparison, and square factory.
    """
